...
const getImageUrl = (id: string, image: string, size: number) => `https://images.svc.ui.com/?u=https://static.ui.com/fingerprint/ui/images/${id}/default/${image}.png&w=${size}&q=100`
